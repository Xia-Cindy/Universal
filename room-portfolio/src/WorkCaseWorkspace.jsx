...
const LEARNING_DOMAINS = [
    ...
    { id: 'governance', index: '03', eyebrow: 'Governance', title: '治理', name: '治理与风险', description: '学习决策权、规则、风险和度量如何让系统长期可靠。', prompt: '谁有权决定，怎样留下可追溯的依据？', outcomes: ['决策与职责', '风险与控制', '度量与改进'], path: ['明确决策边界', '识别风险与控制点', '建立审视与改进回路'] },
    { id: 'operations', index: '04', eyebrow: 'Operations', title: '运维', name: '服务运营', description: '从服务设计到监控、事件响应和持续改进，练习稳定地运行。', prompt: '服务失效时，我如何发现、响应并改善？', outcomes: ['服务与 SOP', '监控与事件响应', '运行复盘'], path: ['定义服务与标准', '建立可观察信号', '演练响应与持续改善'] },
