...
MILESTONE_10_CONTRACTS: tuple[ApiContract, ...] = (
    ApiContract("GET", "/api/ai/status", "ai_status", "shared_ai_core"),
    ...
    ApiContract("POST", "/api/work/tech-stacks/{tech_stack_id}/explorations", "ask_work_exploration", "work_ai_exploration"),
    ApiContract(
        "GET",
