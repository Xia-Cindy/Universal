...
- [x] Add compact title-level article tools that insert images, Excel-like tables and code snippets directly into the article body, plus pasted image/table handling.
