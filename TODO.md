...
- [x] Add compact title-level article tools that insert images, editable tables and code snippets directly into the article body, plus pasted image/table handling, bold text, text color and table row/column operations.
