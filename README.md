...
Tech Stack detail now includes stack management and a focused article editor. The writing surface behaves like a simple manuscript editor: the left outline is generated from headings in text blocks, and a compact toolbar under the title adds structured image, Excel-like table and standalone code blocks without adding extra panels below the editor.
