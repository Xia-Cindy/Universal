...
- Tech Stack article authoring uses the existing `WorkArticle.content` field as Markdown and renders a focused editor with an auto-generated left outline; no new Knowledge, Retrieval, AI Core or RAG behavior is introduced.
